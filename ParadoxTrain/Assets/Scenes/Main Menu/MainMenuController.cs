...
public class MainMenuController : MonoBehaviour {
  ...
  private void PositionSprites(Transform layer) {
  ...
  private void CheckAndRepositionSprite(Transform sprite, int layerIndex) {
  ...
  private float GetRightmostSpritePosition(Transform layer) {
  ...
  private float GetLeftmostSpritePosition(Transform layer) {
  ...
  private float CalculateLayerSpeed(int layerIndex, int totalLayers) {
